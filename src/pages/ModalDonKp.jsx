...
export default function ModalDonKp({ isOpen, onClose, itemName }) {
    ...
    return (
        ...
        <div className="fixed inset-0 bg-gray-300 bg-opacity-75 flex items-center justify-center z-50 p-4">
            ...
            <div className="bg-[#F7EBE5] rounded-lg shadow-xl p-6 sm:p-8 w-full max-w-2xl relative">
                ...
                <div className="flex flex-col  justify-center gap-5 w-full mt-5">
                    <div className="flex flex-col gap-2">
                        <h1>Добавить комментарий</h1>
                        <input className="bg-white py-10 pl-5 w-full  rounded-md" type="text" placeholder="Укажите имя" />
                    </div>
                </div>
